...
class ClassrouterFactory {
    ...
    defaultValue(ins, property) {
        if (ins && property in ins) {
            return ins[property];
        }
        return undefined;
    }
    resolveValue(type, fieldnames, req, defaultValue) {
        return __awaiter(this, void 0, void 0, function* () {
            let find = (store) => {
    ...
    actinHandle(actionType, aMeta) {
        return __awaiter(this, void 0, void 0, function* () {
            const action = (req, res) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    try {
                        ...
                        yield Promise.all(aMeta.properties.map((prop) => __awaiter(this, void 0, void 0, function* () {
                            ...
                            let initVal = yield this.resolveValue(prop.type, prop.fieldname, req, defaultvalue);
                        ...
                        let actionArgs = yield Promise.all(aMeta.actionArguments.map((prop) => __awaiter(this, void 0, void 0, function* () {
                            let initVal = yield this.resolveValue(prop.type, prop.fieldname, req, undefined);
                            let value = yield this.transformValue(initVal, prop.pipes);
                            return value;
                        })));
